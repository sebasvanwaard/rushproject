...
Change the model by changing the path to the model by changing model_path (.h5)
...
model_path = "../src/neural_cost/models/board_cost_model_36x72x144.h5"

# Initialize the gameboard
test_board = Board(board_path)

# Initialize the algorithm
test_algorithm = A_star(test_board, model_path)

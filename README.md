...
- **a_star_lukas**: hierbij hebben we bovenstaande heuristieken veranderd al naar gelang de uitkomst beter werd. Hierdoor zijn we uiteindelijk op de volgende heuristieken uitgekomen:
    - **on_or_off_goalline**: dit is de kosten voor elke verticale auto/trucks tenopzichte van de goal line, hoe meer erop hoe lager de kosten, hoe meer eraf hoe hoger de kosten
    - **cost_h_cars**: dit is de kosten voor alle horizontale auto/trucks tenopzichte van de rode auto, als ze rechts van de auto zijn is de kost hoger
    - **blocking vehicles**: dit is de kosten voor elke voertuig die geblokkeerd wordt, afhankelijk van het soort auto zal de kosten hoger of lager zijn
